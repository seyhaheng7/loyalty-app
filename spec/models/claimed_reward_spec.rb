describe ClaimedReward, 'Validate' do
  context 'Reward in stock?' do
    ...
    let!(:reward1){create(:reward, require_points: 50, quantity: 2, claimed_rewards_count: 0)}
    let!(:reward2){create(:reward, require_points: 300, quantity: 2, claimed_rewards_count: 2)}
